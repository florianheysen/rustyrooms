...
function addMessage(room, username, message, push = false) {
  if (push) {
    ...
    // Scroll en bas de la div à chaque nouveau message
...
function init() {
  ...
  addRoom("Rust");
  changeRoom("Lobby");
  addMessage("Lobby", "Admin", "Hey! Invite your friends, send a message.", true);
  addMessage("Rocket", "Admin", "This is another room. Neat, huh?", true);
  addMessage("Rust", "Admin", "Welcome to Rust topic room", true);
